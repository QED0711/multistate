  ...
  */
  ...
  if (nestedSetters) {
    ...
    try {
      ...
      for (var _iterator = nestedPaths[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        _loop2();
      }
    } catch (err) {
    ...
    value: function createProvider() {
      ...
      var Provider = /*#__PURE__*/function (_Component) {
        ...
        function Provider(props) {
          ...
          _this5 = _possibleConstructorReturn(this, _getPrototypeOf(Provider).call(this, props));
          _this5.state = state;
